...
<head>
    ...
    <style>
        ...
        .btn-tambah:hover { transform: translateY(-1px); color: #fff; opacity: 0.9; }
        .table { margin: 0; }
        .table thead th {
            ...
            <div class="page-card">
                <div class="page-card-header">
                    ...
                    <div class="d-flex gap-2 flex-wrap">
                        <a href="{{ route('mahasiswa.print') }}" target="_blank" class="btn-tambah" style="background: linear-gradient(135deg, #e94560, #c62a47);">
                            <i class="fas fa-file-pdf"></i> Export PDF
                        </a>
                        <a href="{{ route('mahasiswa.exportExcel') }}" class="btn-tambah" style="background: linear-gradient(135deg, #1d6f42, #2d9b5f);">
                            <i class="fas fa-file-excel"></i> Export Excel
                        </a>
                        <a href="{{ route('mahasiswa.exportCsv') }}" class="btn-tambah" style="background: linear-gradient(135deg, #0f3460, #1a6da8);">
                            <i class="fas fa-file-csv"></i> Export CSV
                        </a>
                        <a href="{{ route('mahasiswa.create') }}" class="btn-tambah" style="background: linear-gradient(135deg, #6c757d, #495057);">
